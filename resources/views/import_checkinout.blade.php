  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-primary">
        ...
        <form action="{{ route('import_checkinout.show') }}" method="post" class="frmBookEventShow" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
              <div class="col-sm-6">
        ...
        <form action="{{ route('import_checkinout.save') }}" method="post" class="frmBookEventSave">
          @csrf
          <div class="card-body">
            <div class="row">
              <div class="col-sm-3">
